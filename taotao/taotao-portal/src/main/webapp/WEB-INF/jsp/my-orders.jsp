    ...
    <div class="w">
        ...
        <div id="main">
            <div class="g-0">
                                ...
                                <li>
                                    ...
                                    <div class="tyies-c">
                                        ...
                                        <div class="filter-item">
                                            ...
                                            <div class="item-con">
                                                <a href="list.action?t=0-6-8-9-10-11-13-15-16-17-18-19-21-22-23-24-25-32-33-41-42-49-54-56&amp;d=1&amp;s=4096"
                                                   target="_self">实物商品</a>
                                            </div>
                                        </div>
                                        <div class="filter-item">
                                        ...
                                        <div class="filter-item">
                                            ...
                                            <div class="item-con">
                                                ...
                                                <a href="list.action?t=28-29-201&amp;d=1&amp;s=4096"
                                                   target="_self">团购</a>
                                                <a href="list.action?t=48-64-65&amp;d=1&amp;s=4096"
                                                   target="_self">保险</a>
                ...
                <span class="tcol1">
                    订单编号:
                    <a name="orderIdLinks" id="idUrl${orderInfo.orderId}" target="_blank"
                       href="http://order.jd.com/normal/item.action?orderid=2538292730&amp;PassKey=769448C6BA99F1ADA8244BAE7BC60580"
                       clstag="click|keycount|orderinfo|order_num">${orderInfo.orderId}</a>
                        ...
                        <a class="btn-im" onclick="getPamsForChat()" href="#none" title="联系客服"></a>
                                    ...
                                    <tr id="track2538292730" oty="0,1,70" class="tr-td">
                                        <td>
                                            <div class="img-list">
                                                <c:forEach var="orderItem" items="${orderInfo.orderItems}">
                                                    <a href="http://item.jd.com/1113410.html" class="img-box"
                                                       clstag="click|keycount|orderinfo|order_product" target="_blank">
                                                        <img title="${orderItem.title}" width="50" height="50"
                                                             src="${orderItem.picPath}"
                                                             class="err-product">
                                                    </a>
                                                </c:forEach>
                                            </div>
                                        ...
                                        <td>
                                            <div class="u-name">${orderInfo.orderShipping.receiverName}</div>
                                        </td>
                                        <td>
                                            ￥${orderInfo.payment}<br>
                                            <c:choose>
                                                <c:when test="${orderInfo.paymentType == 1}">在线支付</c:when>
                                                <c:when test="${orderInfo.paymentType == 2}">货到付款</c:when>
                                        ...
                                        <td>
                                            ...
                                            <span class="ftx-03"><fmt:formatDate value="${dateValue}"
                                        ...
                                        <span class="ftx-03">
                                        <c:choose>
                                            <c:when test="${orderInfo.status == 1 }">未付款</c:when>
                                            <c:when test="${orderInfo.status == 2 }">已付款</c:when>
                                        ...
                                        <td id="operate2538292730" class="order-doi" width="100">
                                            ...
                                            <a target="_blank"
                                               ...
                                               clstag="click|keycount|orderinfo|order_check">查看</a><span
                                                ...
                                                target="_blank" clstag="click|keycount|orderinfo|order_comment">评价晒单</a><br></span><a
                                                href="http://myjd.jd.com/repair/ordersearchlist.action?searchString=2538292730"
                                                target="_blank"
                                                clstag="click|keycount|orderinfo|order_repair">申请返修/退换货</a>
